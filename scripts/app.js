...
let isEqual;
isEqual = a==b; //to compare 'a' and 'b' for equality.


let isStrictEqual;
isStrictEqual = a===b; // Use '===' to compare 'a' and 'b' for strict equality.


let isNotEqual;
isNotEqual = a!=b; // Use '!=' to compare 'a' and 'b' for inequality.


let isStrictNotEqual;
isStrictNotEqual= a!==b; // Use '!==' to compare 'a' and 'b' for strict inequality.
...
let isGreaterThan;
isGreaterThan= a>b; // Check if 'a' is greater than 'b'.

let isGreaterOrEqual;
isGreaterOrEqual= a>=b;// Check if 'a' is greater than or equal to 'b'.

let isLessThan;
isLessThan=a<b; // Check if 'a' is less than 'b'.
...
let andResult;
andResult=((a>5)&&(b>5)); //check if both 'a' and 'b' are greater than 5.

let orResult;
orResult= ((a>5||b>5));// check if either 'a' or 'b' is greater than 5.
